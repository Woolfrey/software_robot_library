    ////////////////////////////////////////////////////////////////////////////////////////////////////  
   //                                                                                                //
  //                       A minimum jerk trajectory between 2 orientations                         //
 //                                                                                                //
////////////////////////////////////////////////////////////////////////////////////////////////////
...
class CubicRotation : public CubicSpline
{
	public:
		CubicRotation() : CubicSpline () {}
		
		CubicRotation(const std::vector<Eigen::Quaternionf> &rots, const std::vector<float> &times);
 ...
 //                                            Constructor                                         //
////////////////////////////////////////////////////////////////////////////////////////////////////
CubicRotation::CubicRotation(const std::vector<Eigen::Quaternionf> &rots,
                             ...
                             Q(rots)                                                                         // Orientation at each waypoint
{
	...
	{
		std::cerr << "[ERROR][CUBICROTATION] Constructor : Vectors are not of equal length!" << std::endl;
		std::cerr << "rots: " << rots.size() << " times: " << times.size() << std::endl;
	}
	else if(this->n < 2)
	{
		std::cerr << "[ERROR][CUBICROTATION] Constructor : A minimum of 2 points is required to create a trajectory." << std::endl;
	}
	else
	{
		...
		else
		{
			...
			for(int i = 0; i < this->m; i++)
			{
				...
				{
					s[j] = points[j][i];                                       // points stored as n waypoints with m dimensions
				}
				...
				for(int j = 0; j < this->n-1; j++)
				{
					...
					this->d[i][j] = 0;                                         // Starting at zero for difference over rotation
				}
			}
		}
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool CubicRotation::get_state(Eigen::Quaternionf &rot, Eigen::Vector3f &vel, Eigen::Vector3f &acc, const float &time)
{
