...
class QuinticRotation : public Quintic
{
	public:
		...
		QuinticRotation(const Eigen::Quaternionf &startPoint,
 ...
 //                                            Constructor                                         //
////////////////////////////////////////////////////////////////////////////////////////////////////
QuinticRotation::QuinticRotation(const Eigen::Quaternionf &startPoint,
                                 const Eigen::Quaternionf &endPoint,
                                 const float &startTime,
                                 const float &endTime):
                                 Quintic(),
                                 Q0(startPoint)                                                    // Starting orientation
{
	...
	if(angle > M_PI) angle = 2*M_PI - angle;                                                   // If greater than 180 degrees, take shorter route
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool QuinticRotation::get_state(Eigen::Quaternionf &rot, Eigen::Vector3f &vel, Eigen::Vector3f &acc, const float &time)
{
	...
	{
		std::cerr << "[ERROR][QUINTICROTATION] get_state() : Could not obtain the desired state." << std::endl;
