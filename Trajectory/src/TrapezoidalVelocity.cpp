...
TrapezoidalBase<DataType>::TrapezoidalBase(const Eigen::Vector<DataType, Eigen::Dynamic> &startPosition,
...
template <class DataType>
State<DataType> 
TrapezoidalBase<DataType>::query_state(const DataType &time)
{
