...
class SerialLink
{
	public:
		...
		Eigen::MatrixXf get_inertia();											// Get the inertia matrix of the manipulator in the joint space
	...
	private:
		...
		Eigen::VectorXf g;						// Gravitational torque (nx1) USUALLY AUTOMATICALLY COMPENSATED ON A REAL ROBOT
