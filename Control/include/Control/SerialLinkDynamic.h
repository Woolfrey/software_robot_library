...
#ifndef SERIAL_LINK_DYNAMIC_H
#define SERIAL_LINK_DYNAMIC_H
 ...
 */
class SerialLinkDynamic : public SerialLinkBase
{
	public:
		/**
		 * @brief Constructor.
		 ...
		 */
		SerialLinkDynamic(std::shared_ptr<RobotLibrary::Model::KinematicTree> model,
