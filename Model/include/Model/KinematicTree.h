...
inline
bool
KinematicTree<DataType>::update_state(const Eigen::Vector<DataType, Eigen::Dynamic> &jointPosition,
                                      const Eigen::Vector<DataType, Eigen::Dynamic> &jointVelocity,
                                      const Pose<DataType>                          &basePose,
                                      const Eigen::Vector<DataType, 6>              &baseTwist)
{
...
inline
Eigen::Matrix<DataType,6,Eigen::Dynamic>
KinematicTree<DataType>::jacobian(const std::string &frameName)
{
...
inline
Pose<DataType>
KinematicTree<DataType>::frame_pose(const std::string &frameName)
{
